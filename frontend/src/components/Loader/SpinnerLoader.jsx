    ...
    <div role="status">
      ...
      >
        <path
          ...
          73.1865 27.4043 91.5094 50 91.5094C72.5957 91.5094 90.9186 73.1865 90.9186 50.5908C90.9186 
          27.9951 72.5957 9.67227 50 9.67227C27.4043 9.67227 9.08144 27.9951 9.08144 50.5908Z"
          fill="currentColor"
        />
        <path
          ...
          7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367006 46.6976 
          0.446843 41.7345 1.27873C39.2611 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 
          9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 
          10.0491C60.864 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 
          21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 
