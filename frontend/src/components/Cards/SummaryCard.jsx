...
const SummaryCard = ({
  ...
  return <div className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group m-4" onClick={onSelect}>
