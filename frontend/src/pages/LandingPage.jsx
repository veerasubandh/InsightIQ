...
const LandingPage = () => {
  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#FFFCEF] px-8">
        <div className="absolute w-[500px] h-[500px] bg-amber-200/20 blur-[65px] top-0 left-0 z-0"></div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
              ...
              <h1 className="text-5xl text-black font-bold mb-6 leading-tight">
                ...
                <span className="text-amber-500 bg-clip-text bg-[radial-gradient(circle, _#FF9324_0%,_#FCD760_100%)] bg-[length:200%_200%] animate-text-shine font-semibold">
                  AI - POWERED
                </span>{" "}
                LEARNING
              </h1>
        ...
        <div className="w-full min-h-full bg-[#FFFCEF] mt-10">
          <div className="container mx-auto px-4 pt-10 pb-10">
            <section className="mt-5">
              <h2 className="text-3xl font-semibold text-center mb-12">FEATURES THAT MAKE YOU SHINE</h2>
              <div className="flex flex-col items-center gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {APP_FEATURES.slice(3).map((feature) => (
                    <div key={feature.id} className="bg-[#FFFEF8] p-6 rounded-xl shadow-xs hover:shadow-lg shadow-amber-100 transition border border-amber-100">
                      <h3 className="text-base font-semibold mb-3">{feature.title}</h3>
                      <p className="text-shadow-gray-600">{feature.description}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="text-sm bg-gray-50 text-secondary text-center p-5 mt-5">
          Made with ❤️. Happy coding! | &copy; 2025 InsightIQ.
        </div>
      </div>
